            ...
            <div className="p-8">
              ...
              <section className="mb-8">
                ...
                <div className="text-slate-700 dark:text-slate-300 space-y-1 ml-4">
                  ...
                  <p>
                    {t("Email:", "E-Mail:")} 
                    <a href="mailto:info@infoneva.com" className="text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 ml-1">
                      info@infoneva.com
                    </a>
                  </p>
              ...
              <section className="mb-8">
                ...
                <div className="text-slate-700 dark:text-slate-300 space-y-1 ml-4">
                  <p>Clemens Schmid</p>
                  <p>
                    <a href="mailto:info@infoneva.com" className="text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300">
                      info@infoneva.com
                    </a>
                  </p>
                </div>
